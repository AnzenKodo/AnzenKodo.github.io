...
export async function getBanner(imgOld) {
  const query =
    "#mweb-unauth-container > div > div > div:nth-child(5) > div > div.F6l.k1A.zI7.iyn.Hsu > div > div:nth-child(2) > div > div > div.Pj7.sLG.XiG.ho-.m1e > div > div:nth-child(1) > div > div.XiG.zI7.iyn.Hsu > div";
